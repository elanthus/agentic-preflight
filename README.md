...
[![Python](https://img.shields.io/badge/python-3.11%20%7C%203.12%20%7C%203.13-blue)](https://github.com/elanthus/agentic-preflight/blob/v0.5.0/pyproject.toml)
[![License](https://img.shields.io/badge/license-Apache%202.0-blue)](https://github.com/elanthus/agentic-preflight/blob/v0.5.0/LICENSE)
...
[installation guide](https://github.com/elanthus/agentic-preflight/blob/v0.5.0/docs/installation.md).
...
[change-scope reference](https://github.com/elanthus/agentic-preflight/blob/v0.5.0/docs/change-scope.md)
...
are covered in the
[pre-push hook guide](https://github.com/elanthus/agentic-preflight/blob/v0.5.0/docs/pre-push-hook.md).
...
[Portable attestations and CI enforcement](https://github.com/elanthus/agentic-preflight/blob/v0.5.0/docs/attestations-and-ci.md).
...
[limits guide](https://github.com/elanthus/agentic-preflight/blob/v0.5.0/docs/limits.md).
...
[configuration reference](https://github.com/elanthus/agentic-preflight/blob/v0.5.0/docs/configuration.md).
...
- A supported macOS/Linux/Windows and Python combination from the
  [compatibility policy](https://github.com/elanthus/agentic-preflight/blob/v0.5.0/COMPATIBILITY.md)
- git 2.30+
...
See the [contributor guide](https://github.com/elanthus/agentic-preflight/blob/v0.5.0/CONTRIBUTING.md)
for the full workflow and [support guide](https://github.com/elanthus/agentic-preflight/blob/v0.5.0/SUPPORT.md)
...
Apache 2.0. See the [license](https://github.com/elanthus/agentic-preflight/blob/v0.5.0/LICENSE).
