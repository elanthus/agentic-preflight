...
The [installation guide](https://github.com/elanthus/agentic-preflight/blob/v0.5.2.1/docs/installation.md)
...
- **Lint and test** run the commands configured for the repository and record their exit
  ...
  command through an explicit recorded transition.
...
Read the [limits guide](https://github.com/elanthus/agentic-preflight/blob/v0.5.2.1/docs/limits.md)
...
- Git 2.30+
- A POSIX shell only when a configured stage command uses shell grammar such as pipes or
  `&&`; on Windows, Git for Windows provides it
- `gh` when the agent will create pull requests, inspect hosted checks, or verify merges

## Help and development

Use the [support guide](https://github.com/elanthus/agentic-preflight/blob/v0.5.2.1/SUPPORT.md)
for help and security-reporting routes. Contributors should start with the
[contributor guide](https://github.com/elanthus/agentic-preflight/blob/v0.5.2.1/CONTRIBUTING.md).
